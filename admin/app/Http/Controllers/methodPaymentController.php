...
class methodPaymentController extends Controller
{
    public function list(){
        ...
        $paginate = $methodPaymentModel->getPagination()->first();
        $list_methodPayment = $methodPaymentModel->paginate($paginate->pagination_limitDeaful); 
        ...
        return view('include.main.page.payment.methodPayment.lits', compact('list_methodPayment', 'i', 'check','category','nameElement'));
    }
public function add(){
