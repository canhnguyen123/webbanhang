...
class permissionGroupController extends Controller
{
    public function list(){
        ...
        $paginate = $permissionGroupModel->getPagination()->first(); 
        $list_permissionGroup = $permissionGroupModel->paginate($paginate->pagination_limitDeaful); 
        ...
        return view('include.main.page.system.permissionGroup.lits', compact('list_permissionGroup', 'i', 'check','category','nameElement'));
    }
public function add(){
