...
class bannerController extends Controller
{
    public function list(){
        ...
        $list_banner = $bannerModel->paginate($paginate->pagination_limitDeaful); 
        $check = $list_banner->hasMorePages() ? 1 : 0;
        $i = 1;
        $category=$paginate->pagination_category;
        $nameElement=$paginate->pagination_nameElement;
        return view('include.main.page.banner.lits', compact('list_banner', 'i', 'check','category','nameElement'));
    }
public function add(){
