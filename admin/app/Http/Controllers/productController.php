...
class productController extends Controller
{
    ...
    public function list()
    {
        ...
        $list_product = $productModel->paginate(20);
        ...
        compact('list_product', 'i', 'check','listCategory','listPhanLoai','listSize','listColor','listBrand'));
    }
    public function add()
    {
        $productModel = new productModel();
        ...
        $listColor = $productModel->getListTable('tbl_color', 'color_status');
        $listBrand = $productModel->getListTable('tbl_brand', 'brand_status');
        return view('include.main.page.product.product.add', compact('listCategory', 'listPhanLoai', 'listSize', 'listColor', 'listBrand'));
    }
    ...
    public function post_add(Request $request){
        ...
        try {
            ...
            if ($check) {
                ...
                // Thêm sản phẩm vào bảng tbl_product và lấy product_id

                $add=$product->addproduct($theloai_id,$product_name,$product_code,$brand_product,$baoquan_product,$mota_product,$dacdiem_product,$listImg,$listQuantity);
    ...
    public function update($product_id)
    {
        ...
        return view('include.main.page.product.product.update', compact('listCategory', 'listPhanLoai', 'listSize', 'listColor', 'listBrand','item_product'));
    ...
    public function deatil($product_id)
    {
        ...
        return view('include.main.page.product.product.detail', compact('item_product','item_product_Quantity','item_product_Img'));
