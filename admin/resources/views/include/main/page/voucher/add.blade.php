                            ...
                            <div class="col-12 row">
                                ...
                                <div class="col-6 pd-0-mg-0-b-0 validate-form">
                                    <div class="form-group form-input col-12 ">
                                        ...
                                        <input type="text" name="voucher_name" class="form-control nameProduct " required>
                                ...
                                <div class="col-4 pd-0-mg-0-b-0">
                                    <div class="form-group col-12">
                                        ...
                                        <select class="form-control form-control-lg check-selects" name="voucher_isLimit" id="is-limit-voucher">
                                ...
                                <div class="col-4 pd-0-mg-0-b-0">
                                    <div class="form-group col-12">
                                        ...
                                        <select class="form-control form-control-lg voucher-unit check-selects" id="unit-voucher"  name="voucher_unit">
                                ...
                                <div class="col-4 pd-0-mg-0-b-0 validate-form row">
                                    ...
                                    <div class="col-6 pd-0-mg-0-b-0 validate-form">
                                        <div class="form-group form-input col-12 ">
                                            ...
                                            <input type="text" name="voucher_startTime" class="form-control flatpickr nameProduct " required>
