  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        ...
        <div class="item-icon active-box flex_center mg-5 icon-edit bg-violet" id="ecxel-permissionGroup">
...
<div class="row ">
        ...
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row toggle-filter-div" style="display: none">
            <select class="form-select form-select-lg mb-3" id="filter-status-permissionGroup">
