  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        <a href="{{route('staff_add')}}" class="item-icon flex_center mg-5 icon-edit bg-violet">
        ...
        <div class="item-icon return-icon flex_center mg-5 icon-edit bg-violet" id="return-staff">
...
<div class="row ">
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row div-search" style="display: none">
            <form action="" class="search-form flex_center">
              <input type="text" id="staff-search" class="search-input" placeholder="Nhập thông tin tìm kiếm" required>
                <i id="staff-search-btn" class="mdi icon-search mdi-magnify"></i>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <p class="card-title flex_center"> Danh sách nhân viên</p>
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        @include('ohther.pagination.pagination', [
                          'paginator' => $list_staff,'nameElement'=>$nameElement
                        ])
                      @endif
                      </table>
                    </div>
                  ...
                  @include('ohther.pagination.loadmore', ['pagination_nameElement' => $nameElement,'id'=>$list_staff->last()->staff_id-1,'i'=>$i])
                @endif
                </div>
                </div>
              </div>
