  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        ...
        <div class="item-icon return-icon flex_center mg-5 icon-edit bg-violet" id="return-permission">
...
<div class="row ">
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row div-search" style="display: none">
            <form action="" class="search-form flex_center">
              <input type="text" id="permission-search" class="search-input" placeholder="Nhập thông tin tìm kiếm" required>
                <i id="permission-search-btn" class="mdi icon-search mdi-magnify"></i>
        ...
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row toggle-filter-div" style="display: none">
            <select class="form-select form-select-lg mb-3" id="filter-status-permisstion">
                    ...
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        @include('ohther.pagination.pagination', [
                          'paginator' => $list_permission,'nameElement'=>$nameElement
                        ])
                      @endif
                      ...
                      @if ($check===1&&$category===1)
                        @include('ohther.pagination.loadmore', ['pagination_nameElement' => $nameElement,'id'=>$list_permission->last()->permission_id-1,'i'=>$i])
                      @endif
                </div>
                </div>
              </div>
