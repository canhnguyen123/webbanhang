  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        <a href="{{route('category_add')}}" class="item-icon flex_center mg-5 icon-edit bg-violet">
        ...
        <div class="item-icon return-icon flex_center mg-5 icon-edit bg-violet" id="return-category">
        ...
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row div-search" style="display: none">
            <form action="" class="search-form flex_center">
              <input type="text" id="category-search" class="search-input" placeholder="Nhập thông tin tìm kiếm" required>
                <i id="category-search-btn" class="mdi icon-search mdi-magnify"></i>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        @if ($category===0)
                        @include('ohther.pagination.pagination', ['paginator' => $list_category,'nameElement'=>$nameElement])
                        @endif
                      </table>
                    </div>
                  </div>
                  ...
                  @if ($check===1&&$category===1)
                     @include('ohther.pagination.loadmore', ['pagination_nameElement' => $nameElement,'id'=>$list_category->last()->category_id-1,'i'=>$i])
                  @endif
                </div>
                </div>
              </div>
