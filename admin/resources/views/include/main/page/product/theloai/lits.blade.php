                  ...
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tr>
                            ...
                            <td colspan="3" class="flex_center">
                                <div class="list-icon flex_center">
                                  ...
                                  @if ($item->theloai_status===1)
                                  <a onclick="return confirm('Bạn có muốn ẩn không ?')" href="{{route('theloai_toogle_status',['theloai_id'=>$item->theloai_id,'theloai_status'=>1])}}" class="item-icon mg-5 flex_center icon-edit bg-red-blink">
                                    <i class="mdi mdi-toggle-switch"></i>
                                    <p>Ẩn</p>
                                  </a>   
                                  @else
                                  <a onclick="return confirm('Bạn có muốn hiện không ?')" href="{{route('theloai_toogle_status',['theloai_id'=>$item->theloai_id,'theloai_status'=>0])}}" class="item-icon mg-5 flex_center icon-edit bg-yellow-green">
                        ...
                        @include('ohther.pagination.pagination', ['paginator' => $list_theloai])
