  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        <a href="{{route('color_add')}}" class="item-icon flex_center mg-5 icon-edit bg-violet">
        ...
        <div class="item-icon  flex_center mg-5 icon-edit bg-violet" id="return-color">
          <i class="mdi mdi-keyboard-return"></i>
          <p>Quay lại</p>
        </div>
        <div class="item-icon active-box flex_center mg-5 icon-edit bg-violet" id="ecxel-color">
...
<div class="row ">
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row div-search" style="display: none">
            <form action="" class="search-form flex_center">
              <input type="text" id="color-search" class="search-input" placeholder="Nhập thông tin tìm kiếm" required>
                <i id="color-search-btn" class="mdi icon-search mdi-magnify"></i>
        ...
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row toggle-filter-div" style="display: none">
            <select class="form-select form-select-lg mb-3" id="filter-status-color">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <p class="card-title flex_center"> Danh sách màu sắc</p>
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        @include('ohther.pagination.pagination', [
                          'paginator' => $list_color,'nameElement'=>$nameElement
                        ])
                      @endif
                      </table>
                    </div>
                  ...
                  @include('ohther.pagination.loadmore', ['pagination_nameElement' => $nameElement,'id'=>$list_color->last()->color_id-1,'i'=>$i])
                @endif
                </div>
                </div>
              </div>
