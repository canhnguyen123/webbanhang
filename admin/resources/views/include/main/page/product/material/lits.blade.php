  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        <a href="{{route('material.add')}}" class="item-icon flex_center mg-5 icon-edit bg-violet">
        ...
        <div class="item-icon return-icon flex_center mg-5 icon-edit bg-violet" id="return-material">
...
<div class="row ">
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row div-search" style="display: none">
            <form action="" class="search-form flex_center">
              <input type="text" id="material-search" class="search-input" placeholder="Nhập thông tin tìm kiếm" required>
                <i id="material-search-btn" class="mdi icon-search mdi-magnify"></i>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <p class="card-title flex_center"> Danh sách chất liệu</p>
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        <tbody id="list-material">
                          ...
                          <tr>
                            <td colspan="1">{{$i++}}</td>
                            <td colspan="3">{{$item->material_name}}</td>
                            ...
                            <td colspan="3" class="flex_center">
                                <div class="list-icon flex_center">
                                  <a href="{{route('material.update',['material_id'=>$item->material_id])}}" class="item-icon mg-5 flex_center icon-edit bg-yellow-og">
