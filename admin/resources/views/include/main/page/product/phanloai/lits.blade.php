  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="list-item-titel">
        ...
        <div class="item-icon active-box flex_center mg-5 icon-edit bg-violet" id="ecxel-phanloai">
...
<div class="row ">
        ...
        <div class="col-md-12 grid-margin stretch-card ">
          <div class="row toggle-filter-div" style="display: none">
            <select class="form-select form-select-lg mb-3" id="filter-status-phanloai">
                          ...
                          <tr>
                            ...
                            <td colspan="3" class="flex_center">
                                <div class="list-icon flex_center">
                                  ...
                                  @if ($item->phanloai_status===1)
                                  <a onclick="return confirm('Bạn có muốn ẩn không ?')" href="{{route('phanloai_toogle_status',['phanloai_id'=>$item->phanloai_id])}}" class="item-icon mg-5 flex_center icon-edit bg-red-blink">
                                    <i class="mdi mdi-toggle-switch"></i>
                                    <p>Ẩn</p>
                                  </a>   
                                  @else
                                  <a onclick="return confirm('Bạn có muốn hiện không ?')" href="{{route('phanloai_toogle_status',['phanloai_id'=>$item->phanloai_id])}}" class="item-icon mg-5 flex_center icon-edit bg-yellow-green">
