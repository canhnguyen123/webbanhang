                                        ...
                                        @foreach ($item_product_Quantity as $item)
                                            <div class="swiper-slide item-quantity">
                                                ...
                                                <div class="item-quantity-div item-quantity-price-import">
                                                    <p>Giá nhập: <span>{{ $item->productQuantity_priceInt }}</span></p>
                                                </div>
                                                <div class="item-quantity-div item-quantity-price-out">
                                                    <p>Giá bán: <span>{{ $item->productQuantity_priceOut }}</span></p>
                                                </div>
                                        ...
                                        <div id="carouselExampleDark" class="carousel carousel-dark slide">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active" data-bs-interval="10000">
                                                    {{ $itemProduct->product_dacdiem }}
                                                </div>
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    {{ $itemProduct->product_mota }}
                                                </div>
                                                <div class="carousel-item">
                                                    {{ $itemProduct->product_baoquan }}
                                                </div>
                                            </div>
