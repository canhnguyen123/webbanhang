                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @foreach ($item_product as $itemProduct)
                            ...
                            <form class="forms-sample row col-12" action="{{route('product_post_update',['product_id'=>$itemProduct->product_id])}}" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-12 row">
                                    ...
                                    <div class="col-6 pd-0-mg-0-b-0 form-validate">
                                        <div class="form-group form-input col-12 ">
                                            ...
                                            <input type="text" id="nameProduct" name="nameProduct"
                                                class="form-control check-emty nameProduct" value="{{$itemProduct->product_name}}" required>
                                    ...
                                    <div class="col-6 pd-0-mg-0-b-0 form-validate">
                                        <div class="form-group form-input col-12">
                                            ...
                                            <input type="text" name="product_code"
                                                class="form-control check-emty product_code uppercaseInaput" value="{{$itemProduct->product_code}}" required>
                                            ...
                                            <select class="form-control form-control-lg phanloai_select">
                                                ...
                                                @foreach ($listPhanLoai as $item)
                                                    @if ($itemProduct->phanloai_id != $item->phanloai_id)
                                                        <option value="{{ $item->phanloai_id }}">{{ $item->phanloai_name }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="col-4 pd-0-mg-0-b-0">
                                        <div class="form-group col-12">
                                            ...
                                            <select class="form-control form-control-lg theloai_req theloai_id" name="theloai_id">
                                                <option value="{{ $itemProduct->theloai_id }}">{{ $itemProduct->theloai_name }}
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-6 err"><span></span></div>
                                    ...
                                    <div class="col-6 pd-0-mg-0-b-0">
                                        <div class="form-group col-12">
                                            ...
                                            <select class="form-control brand_product form-control-lg" name="brand_product">
                                                <option value="{{ $itemProduct->brand_id }}">{{ $itemProduct->brand_name }}
                                                </option>
