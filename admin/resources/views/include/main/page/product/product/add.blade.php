                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample row">
                            ...
                            <div class="col-xl-4  col-sm-12 slider-product">
                            ...
                            <div class="col-xl-8 col-sm-12 row">
                                ...
                                <div class="col-xl-6 col-sm-12 pd-0-mg-0-b-0 validate-form">
                                ...
                                <div class="col-xl-4 col-sm-12 pd-0-mg-0-b-0">
                                ...
                                <div class="col-xl-6 col-sm-12 pd-0-mg-0-b-0">
                                  ...
                                  <div class="col-12 row pg-50-0">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-12 flex_start pg-15-0">
                                      <input type="checkbox" class="materialId"  class="mg-right-5" value="{{ $item->material_id }}"> {{ $item->material_name }}
                                    </div>
                                    @endforeach
                                </div>
                                <div class="col-12">
