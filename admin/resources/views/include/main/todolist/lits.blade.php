              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                      <table id="example" class="display expandable-table" style="width:100%">
                        ...
                        @include('ohther.pagination.pagination', [
                          'paginator' => $list_voucher,'nameElement'=>$nameElement
                        ])
                      @endif
                      </table>
                    </div>
                  ...
                  @if ($check===1&&$category===1)
                    @include('ohther.pagination.loadmore', ['pagination_nameElement' => $nameElement,'id'=>$list_voucher->last()->voucher_id-1,'i'=>$i])
                  @endif
                </div>
                </div>
              </div>
