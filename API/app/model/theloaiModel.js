...
exports.getTheloaiChecked = (callback) => {
    const query = 
    `SELECT 
    tbl_theloai.theloai_name,
    tbl_theloaichecked.theloai_id
    FROM  tbl_theloaichecked
    INNER JOIN  tbl_theloai ON tbl_theloaichecked.theloai_id=tbl_theloai.theloai_id
    WHERE tbl_theloaichecked.theloaichecked_status = 1 `;
